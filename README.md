...
* É uma calculadora cujo o objetivo serve para fazer adição, subtração e divisão.
## Objetivo
    * Projeto com ideia de treino para desenvolver minha lógica na linguagem de python.

## 👷 Como rodar  
```
# Clonar o repositório
    git clone Yuy69/Calculadora
